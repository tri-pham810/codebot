...
export class FishEffect {
  ...
  constructor(
    ...
    protected readonly service: FishService // % protected region % [Add any additional constructor parameters here] off begin // % protected region % [Add any additional constructor parameters here] end
  ) {
  ...
  countModels = this.action$.pipe(
    ...
    concatMap((action) => {
      ...
      return this.service.count().pipe(
        ...
        map(
          (stateConfig) =>
            new modelAction.CountFishModelsOK(
              {
                ...stateConfig,
        ...
        concatMap((innerAction) => [innerAction, ...innerAction.afterwardActions]),
        ...
        catchError((err) => {
          return [new modelAction.CountFishModelsFail(err)];
        })
      );
    })
  ...
  fetchedModel = this.action$.pipe(
    ...
    concatMap((action) => {
      ...
      return this.service.get(modelId, queryParams).pipe(
        ...
        map(
          (stateConfig) =>
            new modelAction.FetchFishModelOK(
              {
                ...action.stateConfig,
                ...stateConfig,
        ...
        catchError((err) => {
          return [new modelAction.FetchFishModelFail(modelId, err)];
        })
      );
    })
  ...
  fetchedModels = this.action$.pipe(
    ...
    ofType<modelAction.FetchAllFishModels>(
      modelAction.FishModelActionTypes.FETCH_ALL_FISH
    ),
    ...
    concatMap((action) => {
      ...
      return this.service.getAll().pipe(
        ...
        map(
          (stateConfig) =>
            new modelAction.FetchAllFishModelsOK(
              {
                ...action.stateConfig,
                ...stateConfig,
        ...
        catchError((err) => {
          return [new modelAction.FetchAllFishModelsFail(err)];
        })
      );
    })
  ...
  fetchModelWithQuery = this.action$.pipe(
    ...
    ofType<modelAction.FetchFishModelsWithQuery>(
      modelAction.FishModelActionTypes.FETCH_FISH_WITH_QUERY
    ),
    ...
    concatMap((action) => {
      ...
      return this.service.getWithQuery(queryParams).pipe(
        ...
        map(
          (stateConfig) =>
            new modelAction.FetchFishModelsWithQueryOK(
              {
                ...action.stateConfig,
                ...stateConfig,
        ...
        catchError((err) => {
          return [new modelAction.FetchFishModelsWithQueryFail(err)];
        })
      );
    })
  ...
  fetchLastModelWithQuery = this.action$.pipe(
    ...
    ofType<modelAction.FetchLastFishModelsWithQuery>(
      modelAction.FishModelActionTypes.FETCH_LAST_FISH_WITH_QUERY
    ),
    ...
    concatMap((action) => {
      ...
      return this.service.getLastWithQuery(queryParams).pipe(
        ...
        map(
          (stateConfig) =>
            new modelAction.FetchLastFishModelsWithQueryOK(
              {
                ...action.stateConfig,
                ...stateConfig,
        ...
        catchError((err) => {
          return [new modelAction.FetchLastFishModelsWithQueryFail(err)];
        })
      );
    })
  ...
  createdModel = this.action$.pipe(
    ...
    concatMap((action) => {
      ...
      return this.service.create(modelToBeCreated, queryParams).pipe(
        ...
        map(
          (stateConfig) =>
            new modelAction.CreateFishModelOK(
              {
                ...action.stateConfig,
                ...stateConfig,
        ...
        catchError((err) => {
          return [new modelAction.CreateFishModelFail(modelToBeCreated, err)];
        })
      );
    })
  ...
  createAllModels = this.action$.pipe(
    ...
    ofType<modelAction.CreateAllFishModel>(
      modelAction.FishModelActionTypes.CREATE_ALL_FISH
    ),
    ...
    concatMap((action) => {
      ...
      return this.service.createAll(modelsToCreate, queryParams).pipe(
        ...
        map(
          (stateConfig) =>
            new modelAction.CreateAllFishModelOK(
              {
                ...action.stateConfig,
                ...stateConfig,
        ...
        catchError((err) => {
          return [new modelAction.CreateAllFishModelFail(modelsToCreate, err)];
        })
      );
    })
    ...
    concatMap((action) => {
      ...
      return this.service
        ...
        .pipe(
          ...
          map(
            (stateConfig) =>
              new modelAction.UpdateFishModelOK(
                {
                  ...action.stateConfig,
                  ...stateConfig,
          ...
          catchError((err) => {
            return [new modelAction.UpdateFishModelFail(modelToBeUpdated, err)];
          })
        );
    })
  ...
  updateAllModels = this.action$.pipe(
    ...
    concatMap((action) => {
      ...
      return this.service.updateAll(updatedModels, queryParams).pipe(
        ...
        map(
          (stateConfig) =>
            new modelAction.UpdateAllFishModelOK(
              {
                ...action.stateConfig,
                ...stateConfig,
        ...
        catchError((err) => {
          return [new modelAction.UpdateAllFishModelFail(modelsToUpdate, err)];
        })
      );
    })
  ...
  deletedModel = this.action$.pipe(
    ...
    concatMap((action) => {
      ...
      return this.service.delete(modelIdToBeDeleted).pipe(
        ...
        map(
          (stateConfig) =>
            new modelAction.DeleteFishModelOK(
              {
                ...action.stateConfig,
                ...stateConfig,
        ...
        catchError((err) => {
          return [new modelAction.DeleteFishModelFail(modelIdToBeDeleted, err)];
        })
      );
    })
  ...
  deletedModels = this.action$.pipe(
    ...
    ofType<modelAction.DeleteFishModels>(
      modelAction.FishModelActionTypes.DELETE_ALL_FISH
    ),
    ...
    concatMap((action) => {
      ...
      return this.service.deleteAll(modelIdsToBeDeleted).pipe(
        ...
        map(
          (stateConfig) =>
            new modelAction.DeleteFishModelsOK(
              {
                ...action.stateConfig,
                ...stateConfig,
        ...
        catchError((err) => {
          return [new modelAction.DeleteFishModelsFail(modelIdsToBeDeleted, err)];
        })
      );
    })
  ...
  fetchedAudits = this.action$.pipe(
    ...
    ofType<modelAction.FetchFishModelAudit>(
      modelAction.FishModelActionTypes.FETCH_FISH_AUDIT
    ),
    ...
    concatMap((action) => {
      ...
      return this.service.getAudits().pipe(
        ...
        map(
          (audits) =>
            new modelAction.FetchFishModelAuditOK(
              audits,
        ...
        catchError((err) => {
          return [new modelAction.FetchFishModelAuditFail(err)];
        })
      );
    })
  ...
  fetchedAuditsByEntityId = this.action$.pipe(
    ...
    ofType<modelAction.FetchFishModelAuditsByEntityId>(
      modelAction.FishModelActionTypes.FETCH_FISH_AUDITS_BY_ENTITY_ID
    ),
    ...
    concatMap((action) => {
      ...
      return this.service.getAuditsByEntityId(entityId).pipe(
        ...
        map(
          (audits) =>
            new modelAction.FetchFishModelAuditsByEntityIdOK(
              audits,
        ...
        catchError((err) => {
          return [new modelAction.FetchFishModelAuditsByEntityIdFail(err)];
        })
      );
    })
  ...
  @Effect()
  fetchAlivePurchasedFish = this.action$.pipe(
    ofType<modelAction.FetchAlivePurchasedFish>(
      modelAction.FishModelActionTypes.FETCH_ALIVE_PURCHASED_FISH
    ),

    concatMap((action) => {
      return (
        this.service.getFishByAliveAndPurchased().pipe(
          map(
            (stateConfig) =>
              new modelAction.FetchAlivePurchasedFishOk({
                ...action.stateConfig,
                ...stateConfig,
              }),
            action.afterwardActions
        ...
        concatMap((innerAction) => [innerAction, ...innerAction.afterwardActions]),
        catchError((err) => {
          return [new modelAction.FetchAlivePurchasedFishFail(err)];
        })
      );
    })
  );
