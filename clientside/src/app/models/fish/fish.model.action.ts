...
export enum FishModelActionTypes {
  ...
  FETCH_ALIVE_PURCHASED_FISH = '[ENTITY] Fetch alive and purchased FishModel',
  FETCH_ALIVE_PURCHASED_FISH_OK = '[ENTITY] Fetch alive and purchased successfully',
  FETCH_ALIVE_PURCHASED_FISH_FAIL = '[ENTITY] Fetch alive and purchased failed',
...
export class FetchFishModelAuditsByEntityIdOK extends BaseFishAction {
  readonly type: string =
    FishModelActionTypes.FETCH_FISH_AUDITS_BY_ENTITY_ID_OK;
...
export class FetchFishModelAuditsByEntityIdFail extends BaseFishAction {
  readonly type: string =
    FishModelActionTypes.FETCH_FISH_AUDITS_BY_ENTITY_ID_FAIL;
...
// % protected region % [Add any additional actions here] on begin
export class FetchAlivePurchasedFish extends BaseFishAction {
  readonly type: string = FishModelActionTypes.FETCH_ALIVE_PURCHASED_FISH;
...
export class FetchAlivePurchasedFishOk extends BaseFishAction {
  readonly type: string = FishModelActionTypes.FETCH_ALIVE_PURCHASED_FISH_OK;
...
export class FetchAlivePurchasedFishFail extends BaseFishAction {
  readonly type: string = FishModelActionTypes.FETCH_ALIVE_PURCHASED_FISH_FAIL;
