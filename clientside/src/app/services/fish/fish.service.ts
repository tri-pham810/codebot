...
export class FishService extends AbstractHttpService<
  FishModel,
  FishModelAudit
> {
  ...
  get(
  ...
  ): Observable<PassableStateConfig<FishModel>> {
    ...
    const expands =
      queryParams && queryParams.expands ? queryParams.expands : [];
  ...
  create(
    ...
    return this.apollo
      ...
      .pipe(
        tap(() =>
          this.toastrService.success('Created Fish entity successfully')
        ),
        map((result) => {
      ...
      .pipe(
        tap(() =>
          this.toastrService.success(
            'Created Multiple Fish entities successfully'
          )
        ),
        map((result) => {
  ...
  update(
    ...
    return this.apollo
      ...
      .pipe(
        tap(() =>
          this.toastrService.success('Updated Fish entity successfully')
        ),
        map((result) => {
  ...
  updateAll(
    ...
    return this.apollo
      ...
      .pipe(
        tap(() =>
          this.toastrService.success(
            'Update Multiple Fish entities successfully'
          )
        ),
        map((result) => {
  ...
  delete(id: string): Observable<PassableStateConfig<FishModel>> {
    ...
    return this.apollo
      ...
      .pipe(
        tap(() =>
          this.toastrService.success('Deleted Fish entity successfully')
        ),
        map((result) => {
  ...
  deleteAll(ids: string[]): Observable<PassableStateConfig<FishModel>> {
    ...
    return this.apollo
      ...
      .pipe(
        tap(() =>
          this.toastrService.success('Deleted all Fish entities successfully')
        ),
        map((result) => {
  ...
  getFishByAliveAndPurchased(): Observable<PassableStateConfig<FishModel>> {
    return this.apollo
      .query<any>({
        query: gql`
			query GetFishByAliveAndPurchased{
				fishes: getFishByAliveAndPurchased{
					...FishProperties,
				}
			}
			${this.classFragments.properties},
      ...
      .pipe(
        map((result) => {
          return {
            collectionCount: result.data.fishes.length,
            targetModule: result.data.fishes as FishModel[],
          };
        })
      );
  }
