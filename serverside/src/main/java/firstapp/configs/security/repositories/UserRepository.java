...
package firstapp.configs.security.repositories;
 ...
 * {@link firstapp.repositories.UserRepository} since we want to be able to query all user tables at once
 ...
 * against all user types at once, which is not possible for {@link firstapp.repositories.UserRepository}.
 */
@Repository
public interface UserRepository extends firstapp.repositories.UserRepository<UserEntity> {
