...
-- Insert Dentist Tank
insert into tank_entity (id, created, created_by, modified, modified_by, clean, height, last_cleanned, length, name, width) values (tank_uuid, now(), null, now(), null, null, 300, now(), 200, 'Dentist Tank', 200);
-- Insert Species
